// https://leetcode.com//problems/maximum-size-subarray-sum-equals-k/#/description		 QuestionId:325
import java.io.*; 
import java.util.*; 
/*
...
For each i, check not only the current sum but also (currentSum - previousSum) to
